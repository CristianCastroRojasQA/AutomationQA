...
from products.paystudio.repository.configuracion.adquirente.tecnologias_repository import TecnologiasRepository
...
class TestTecnologiaTerminales:
    ...
    def test_tc03_duplicado_exacto(self, auth, page):
        ...
        try:
            flow = self._login_y_navegar(auth, page, nombre_caso_prueba, logger_test)
            nombre_duplicado = flow.generar_nombre_unico("TEC_DUPLICADO")
    ...
    def test_tc12_texto_mensaje_warning(self, auth, page):
        """TC-12: Verificar que el mensaje warning aparezca tras un registro duplicado."""
    ...
    def test_tc13_texto_mensaje_error_relacion(self, auth, page, db_instance):
        """TC-13: Verificar que el mensaje error aparezca tras intentar eliminar un registro relacionado."""
