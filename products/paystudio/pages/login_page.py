...
class LoginPage(BasePage):
    """
    Page Object Model para el módulo de Autenticación de PayStudio.
    ...
    def validar_presencia_login(self) -> None:
        """Verifica que los elementos críticos del login estén listos."""
    ...
    def validar_retorno_a_login(self) -> None:
        """Confirma que el flujo de salida terminó en la pantalla de acceso."""
    ...
    def ejecutar_login_tecnico(self, usuario: str, password: str) -> None:
        ...
        try:
            ...
            self.log.error(f"Error crítico al intentar ingresar credenciales para {usuario}.")
            raise e
    ...
    def confirmar_cierre_sesion(self) -> None:
        """Maneja la pantalla intermedia de confirmación de PayStudio."""
        ...
        try:
            ...
            self.log.warning("El mensaje de éxito de logout tardó más de lo esperado.")
            raise
