...
from products.paystudio.pages.configuracion.adquirente.base_catalogo_page import BaseCatalogoPage
...
class TecnologiasPage(BaseCatalogoPage):
    ...
    INPUT_MAX_LENGTH = "50"
    SUCCESS_TEXT = "Tecnologías de comunicación actualizadas correctamente"
