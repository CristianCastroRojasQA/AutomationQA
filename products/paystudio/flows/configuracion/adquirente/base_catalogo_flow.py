...
from core.utils.bug_reporter import BugReporter
from core.utils.logger import get_logger
from core.utils.screenshots import capturar_evidencia
from core.utils.sql_evidence import capturar_evidencia_sql
...
class BaseCatalogoFlow(ABC):
    ...
    def generar_nombre_unico(prefijo: str = "QA_Test") -> str:
        ...
        return DataFactory.generar_nombre_unico(prefijo)
